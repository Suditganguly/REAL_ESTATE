...
// import { properties as initialData } from '../data/properties';
...
//     setFormData({ title: '', price: '', status: 'available' });
//     setShowForm(false);
//   };
...
//       {showForm && (
//         <form className="flex flex-col gap-2 mb-4" onSubmit={handleFormSubmit}>
//           <input
//             type="text"
//             name="title"
...
//             required
//             className="p-2 text-base border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
//           />
//           <input
//             type="number"
//             name="price"
...
//             <div>
//               <button
//                 className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-md mr-2 transition"
